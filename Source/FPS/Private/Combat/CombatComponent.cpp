...
{
	//GEngine->AddOnScreenDebugMessage(	-1, 5.f, FColor::Red, TEXT("Initiate_Aim_Pressed"), false);
	Local_Aim(true);
	Server_Aim(true);
}
...
{
	//GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Blue, TEXT("Initiate_Aim_Released"), false);
	Local_Aim(false);
	Server_Aim(false);
}
